...
class SolvinityExtendedExperiment : Experiment("Bitbrains baseline portfolio scheduling experiment") {
    ...
    override fun doRun(repeat: Int) {
        ...
        reflectionResults.add(Pair(FilterScheduler(
            ...
            weighers= listOf(InstanceCountWeigher(1.0), VCpuWeigher(3.0,0.22)), subsetSize = 21),3324300000))
