...
class SolvinityGeneticSearchExperiment : Experiment("Genetic Search Experiment") {
    ...
    private var snapshotFolder = "Solvinity_baseline"
    ...
    override fun doRun(repeat: Int) {
         runGeneticSearch(snapshotFolder, 0..91)
    }
