...
PS40 <- read.table("bitbrains/Portfolio_Scheduler40m.txt",header = TRUE)
PS40History <- read.table("bitbrains/Portfolio_Scheduler40m_history.txt")

PS60 <- read.table("bitbrains/Portfolio_Scheduler60m.txt",header = TRUE)
PS60History <- read.table("bitbrains/Portfolio_Scheduler60m_history.txt")
